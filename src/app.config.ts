...
const appConfig: Config = {
  pages: ["pages/create-instantaneous/index", "pages/instantaneous/index", "pages/activity/index", "pages/user/index", "pages/institution/index", "pages/my-like/index", "pages/my-instantaneous/index", "pages/activity-detail/index"],
  window: {
